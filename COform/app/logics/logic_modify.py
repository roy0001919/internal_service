...
class Logic_Mod:
    ...
    def insert_COform(self):
        ...
        print("2")
        sql = "UPDATE public.web_fin_mailorder SET auth_code={}, auth_date={}, req_date={}, mod_r_id={}, mod_date={}, bank_req_date={} WHERE coform_id={}".format(modDict['auth_code'], modDict['auth_date'], modDict['req_date'], modDict['mod_r_id'], modDict['mod_date'], modDict['bank_req_date'], modDict['coform_id'])
        print("error code")
